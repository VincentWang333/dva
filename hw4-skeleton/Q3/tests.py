...
def linearTest(Data, LinearRegression):
    ...
    try:
        y_predict_train, y_predict_test = linear.linearClassifier(
    ...
    try:
        print("Linear Regression Train Accuracy: ",
              linear.lgTrainAccuracy(y_train, y_predict_train))
    except:
        print("Failed to execute lgTrainAccuracy()")
    try:
        print("Linear Regression Test Accuracy: ",
              linear.lgTestAccuracy(y_test, y_predict_test))
    except:
...
def RandomForestTest(Data, RFClassifier):
    ...
    x_train, x_test, y_train, y_test = dataset.trainSets(x_data, y_data)
    try:
        rf_clf, y_predict_train, y_predict_test = rf.randomForestClassifier(
            x_train, x_test, y_train)
    ...
    try:
        print("Random Forest Train Accuracy: ",
              rf.rfTrainAccuracy(y_train, y_predict_train))
    except:
        print("Failed to execute rfTrainAccuracy()")
    try:
        print("Random Forest Test Accuracy: ",
              rf.rfTestAccuracy(y_test, y_predict_test))
    except:
        print("Failed to execute rfTrainAccuracy()")
    try:
        print("Random Forest Feature Importance: ",
              rf.rfFeatureImportance(rf_clf))
    except:
        print("Failed to execute rfFeatureImportance()")
    try:
        print("Random Forest Sorted Feature Importance: ",
              rf.sortedRFFeatureImportanceIndicies(rf_clf))
    except:
...
def SupportVectorMachineTest(Data, SupportVectorMachine):
    ...
    try:
        y_predict_train, y_predict_test = svm.SVCClassifier(
    ...
    try:
        y_predict_train, y_predict_test = svm.SVCClassifierParam(
            svm_cv, scaled_x_train, scaled_x_test, y_train)
    ...
    try:
        ...
        print("Failed to execute SVCTestAccuracy()")
    try:
        print("Support Vector Machine Rank Test Score: ",
              svm.SVMRankTestScore(svm_cv))
    except:
        print("Failed to execute SVCTestAccuracy()")
    try:
        print("Support Vector Machine Mean Test Score: ",
              svm.SVMMeanTestScore(svm_cv))
    except:
        print("Failed to execute SVCTestAccuracy()")
...
def PCATest(Data, PCAClassifier):
    ...
    try:
        print("PCA Explained Variance Ratio: ",
              pc.pcaExplainedVarianceRatio(pca))
    except:
